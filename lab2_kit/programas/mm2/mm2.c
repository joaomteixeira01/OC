...
int main() {
    ...
    // setup(mul1, mul2, res); this is how it was before chaging for the question 3.2.2.c)
    ...
    /* Setup matrices and include transposition in execution time */
    setup(mul1, mul2, res); // Added for responding to the question 3.2.2.c)
